...
= struct
  ...
  let mk
    ...
    let sys_csts  = Sys_Cst_Map.empty  in
    { conf; in_scope; type_vars; type_csts; term_vars; term_csts; sys_csts; }
  ...
  let find_opt t id =
    ...
    | `Sys_cst  s -> Sys_Cst_Map.find_opt s t.sys_csts

...
type expect =
  | Nothing
  | Type
  | Typed of Dolmen.Std.Expr.Ty.t
  (** The type of expected result when typing an expression, used to infer
      non-declared symbols. *)

type tag = Any : 'a Dolmen.Std.Tag.t * 'a -> tag
(** Existencial wrapper around tags *)

type res =
  | Ttype
  | Ty    of Dolmen.Std.Expr.Ty.t
  | Term  of Dolmen.Std.Expr.Term.t
  | Tags  of tag list (**)
(** The results of parsing an untyped term.  *)

type builtin_res = [
  | `Ttype of (Dolmen.Std.Term.t -> Dolmen.Std.Term.t list -> unit)
  | `Ty    of (Dolmen.Std.Term.t -> Dolmen.Std.Term.t list -> Dolmen.Std.Expr.Ty.t)
  | `Term  of (Dolmen.Std.Term.t -> Dolmen.Std.Term.t list -> Dolmen.Std.Expr.Term.t)
...
type var = [
  | `Ty_var of Dolmen.Std.Expr.Var.t
  | `Term_var of Dolmen.Std.Expr.Var.t
  | `Letin of Dolmen.Std.Term.t * Dolmen.Std.Expr.Var.t * Dolmen.Std.Expr.Term.t
]
(** Variable bindings *)

type cst = [
  | `Cstr of Dolmen.Std.Expr.Cstr.t
  | `Field of Dolmen.Std.Expr.Field.t
  | `Ty_cst of Dolmen.Std.Expr.Cst.t
  | `Term_cst of Dolmen.Std.Expr.Cst.t
]
(** Constant bindings *)
...
type inferred =
  | Ty_fun of Dolmen.Std.Expr.Cst.t
  | Term_fun of Dolmen.Std.Expr.Cst.t (**)
...
type binding = [
  ...
  | `Variable of [
      | `Ty of Dolmen.Std.Expr.Var.t * reason option
      | `Term of Dolmen.Std.Expr.Var.t * reason option
    ]
  | `Constant of [
      | `Ty of Dolmen.Std.Expr.Cst.t * reason option
      | `Cstr of Dolmen.Std.Expr.Cstr.t * reason option
      | `Term of Dolmen.Std.Expr.Cst.t * reason option
      | `Field of Dolmen.Std.Expr.Field.t * reason option
    ]
]
...
type _ warn +=
  | Unused_type_variable : Dolmen.Std.Expr.Var.t -> Dolmen.Std.Term.t warn
  (** Unused quantified type variable *)
  | Unused_term_variable : Dolmen.Std.Expr.Var.t -> Dolmen.Std.Term.t warn
  ...
  | Superfluous_destructor :
      Dolmen.Std.Id.t * Dolmen.Std.Id.t * Dolmen.Std.Expr.Cst.t -> Dolmen.Std.Term.t warn
...
type _ err +=
  ...
  | Bad_ty_arity : Dolmen.Std.Expr.Cst.t * int -> Dolmen.Std.Term.t err
  ...
  | Bad_cstr_arity : Dolmen.Std.Expr.Cstr.t * int list * int -> Dolmen.Std.Term.t err
  (** [Bad_cstr_arity (cstr, expected, actual)] denotes an ADT constructor,
      ...
      to [actual] arguments. *)
  | Bad_term_arity : Dolmen.Std.Expr.Cst.t * int list * int -> Dolmen.Std.Term.t err
  (** [Bad_term_arity (func, expected, actual)] denotes a funciton symbol,
      which was expecting one of [expected] arguments, but which was applied
      to [actual] arguments. *)
  | Repeated_record_field : Dolmen.Std.Expr.Field.t -> Dolmen.Std.Term.t err
  ...
  | Missing_record_field : Dolmen.Std.Expr.Field.t -> Dolmen.Std.Term.t err
  (** [Missing_record_field f] denotes an error within an expression
      that builds a record by giving values to all fields, but where the
      field [f] does not appear. *)
  | Mismatch_record_type :
      Dolmen.Std.Expr.Field.t * Dolmen.Std.Expr.Cst.t -> Dolmen.Std.Term.t err
  ...
  (** *)
  | Unbound_variables :
      Dolmen.Std.Expr.Var.t list *
      Dolmen.Std.Expr.Var.t list *
      Dolmen.Std.Expr.Term.t -> Dolmen.Std.Term.t err
  (** *)
...
val empty_env :
  ...
  ?infer_base:Dolmen.Std.Expr.Ty.t ->
  ?poly:poly ->
  ?quants:bool ->
...
val parse_ty : Dolmen.Std.Expr.Ty.t typer
val parse_term : Dolmen.Std.Expr.Term.t typer
val parse_prop : Dolmen.Std.Expr.Term.t typer
(** Wrappers around {parse_expr} to set the expect field of the env,
    and unwrap an expected return value. *)

val parse_app_ty : (Dolmen.Std.Expr.Cst.t -> Dolmen.Std.Term.t list -> res) typer
val parse_app_term : (Dolmen.Std.Expr.Cst.t -> Dolmen.Std.Term.t list -> res) typer
...
val unwrap_ty : env -> Dolmen.Std.Term.t -> res -> Dolmen.Std.Expr.Ty.t
val unwrap_term : env -> Dolmen.Std.Term.t -> res -> Dolmen.Std.Expr.Term.t
...
val decls :
  ...
  Dolmen.Std.Statement.decls -> [
    | `Type_decl of Dolmen.Std.Expr.Cst.t
    | `Term_decl of Dolmen.Std.Expr.Cst.t
  ] list
...
val defs :
  ...
  Dolmen.Std.Statement.defs -> [
    | `Type_def of Dolmen.Std.Id.t *
                   Dolmen.Std.Expr.Cst.t *
                   Dolmen.Std.Expr.Var.t list *
                   Dolmen.Std.Expr.Ty.t
    | `Term_def of Dolmen.Std.Id.t *
                   Dolmen.Std.Expr.Cst.t *
                   Dolmen.Std.Expr.Var.t list *
                   Dolmen.Std.Expr.Var.t list *
...
val parse : Dolmen.Std.Expr.Term.t typer
(** Parse a formula *)
